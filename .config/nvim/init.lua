...
-- vimp.nnoremap({'silent'}, '<leader>so', [[<cmd>lua require('telescope.builtin').tags{ only_current_buffer = true }<CR>]])
...
local on_attach = function(_, bufnr)
  ...
  vimp.add_buffer_maps(bufnr, function()
    vimp.nnoremap('<leader>lf', [[<cmd>lua vim.lsp.buf.formatting_sync(nil, 200)<CR>]])
