...
let g:nvim_tree_ignore=[ '.git', 'node_modules', '.cache', 'target', 'buck-out' ] "empty by default
...
let g:nvim_tree_special_files=[ 'README.md', 'Makefile' ] " List of filenames that gets highlighted with NvimTreeSpecialFile
